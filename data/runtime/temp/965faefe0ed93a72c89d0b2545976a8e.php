<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:28:"./template/pc/lists_note.htm";i:1631927609;s:49:"D:\phpstudy_pro\WWW\doudou\template\pc\header.htm";i:1631599279;s:49:"D:\phpstudy_pro\WWW\doudou\template\pc\footer.htm";i:1631534659;}*/ ?>
<!DOCTYPE html>
<html>
    <head> 
...
<div class="pop_search">
    ...
    <div class="search_container">
        ...
        <div class="page">
            <div class="cover_bg">
                <div class="cover_pic">
                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/note_bg.jpg">
                </div>
            ...
            <div class="note">
                <div class="note_list">
                    <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "",      "keyword"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 20, "", "weather,article_content", "desc", "on","off");if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 60, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
                    <li>
                        <div class="note_article">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/avatar.jpg" class="note_avatar">
                            <div class="note_text">
                                <p><?php echo $field['article_content']; ?></p>
                                <div class="note_cate">
                                    <span class="note_weather <?php if(($field['weather'] == "晴")): ?>sun<?php elseif(($field['weather'] == "多云")): ?>cloudy<?php elseif(($field['weather'] == "雨")): ?>rain<?php elseif(($field['weather'] == "夜晚")): ?>moonlight<?php else: ?>sun<?php endif; ?>"></span>
                                    <span class="note_time"><?php echo MyDate('Y-m-d H:i:s',$field['add_time']); ?></span>
                                </div>
                            </div>
                        </div>
                    </li>
