<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin\login.htm";i:1623929754;s:71:"D:\phpstudy_pro\WWW\doudou\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!DOCTYPE html>
...
<html>
    <head>
        ...
        <link href="/doudou/public/static/admin/css/login.css" rel="stylesheet" type="text/css" />
        <link href="/doudou/public/static/admin/css/diy_style.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css" />
        <style type="text/css">
            body {background:#6f8489 url('<?php echo (handle_subdir_pic($global['web_loginbgimg']) ?: '/doudou/public/static/admin/loginbg/login-bg-1.png'); ?>') left top no-repeat;}
        </style>
        <script type="text/javascript" src="/doudou/public/static/admin/js/jquery.js"></script>
        <script type="text/javascript" src="/doudou/public/static/admin/js/jquery.SuperSlide.2.1.2.js"></script>
    ...
    <body>
        ...
        <div class="container">
            <div class="logo">
                ...
                <img src="<?php echo (handle_subdir_pic($global['web_loginlogo']) ?: '/doudou/public/static/admin/images/login-logo_ey.png'); ?>?v=<?php echo time(); ?>">
                <?php else: ?>
                <img src="<?php echo (handle_subdir_pic($global['web_loginlogo']) ?: '/doudou/public/static/admin/images/login-logo.png'); ?>?v=<?php echo time(); ?>">
                <?php endif; ?>
            </div>
            <div class="box">
