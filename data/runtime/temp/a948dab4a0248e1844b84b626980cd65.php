<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/template/field\modelfield.htm";i:1622084942;s:84:"D:\phpstudy_pro\WWW\doudou\application\admin\template\diy_extend\archives_extend.htm";i:1571728724;}*/ ?>
                            ...
                            <div class="images_upload" style="display:inline-block;">
                                <div style="position: relative; height: 130px;">
                                    ...
                                    <a href="javascript:void(0);" onClick="" class="upimg" title="拖动修改排序">
                                        <img src="/doudou/public/static/admin/images/add-button.jpg" width="136" height="136" />
                                    </a>
                ...
                <script type="text/javascript">
                    ...
                    function <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_call_back(paths){
                        ...
                        for (var i=0;i<paths.length ;i++ )
                        {
                            ...
                            $("#dl_<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>").find(".images_upload:eq(0)").find('a:eq(1)').attr('onclick',"<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_ClearPicArr2(this,'"+paths[i]+"')").text('');
                ...
                <?php else: ?>
                    ...
                    <script type="text/javascript">
                        ...
                        CKEDITOR.replace(elemtid, {
                            filebrowserBrowseUrl: "<?php echo url('Ueditor/index', ['savepath'=>'ueditor', 'action'=>'uploadimage']); ?>",
                            filebrowserImageBrowseUrl: "<?php echo url('Ueditor/index', ['savepath'=>'ueditor', 'action'=>'uploadimage']); ?>",
                            filebrowserUploadUrl: "<?php echo url('Ueditor/index', ['savepath'=>'ueditor', 'action'=>'uploadimage']); ?>",
                            filebrowserImageUploadUrl: "<?php echo url('Ueditor/index', ['savepath'=>'ueditor', 'action'=>'uploadimage']); ?>",
                        });
