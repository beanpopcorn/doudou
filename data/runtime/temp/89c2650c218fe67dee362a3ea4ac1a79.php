<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/index\welcome.htm";i:1622084942;s:74:"D:\phpstudy_pro\WWW\doudou\application\admin\template\public\theme_css.htm";i:1622084942;s:71:"D:\phpstudy_pro\WWW\doudou\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<link href="/doudou/public/static/admin/css/index.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">
<!--[if IE 7]>
            ...
            <div class="section system_section" style="float: none;width: inherit;">
                <div class="system_section_con">
                    <div class="sc_title" style="padding: 26px 0 14px;">
                        ...
                        <h3><i class="fa fa-gear"></i>系统信息</h3>
                    </div>
...
<script type="text/javascript">
                ...
                success: function(res) {
                    if (1 == res.code) {
                        if (2 == res.data.code) {
                            ...
                            var webShowPopupUpgrade = "<?php echo $web_show_popup_upgrade; ?>";
                            var adminInfoRoleID = "<?php echo \think\Session::get('admin_info.role_id'); ?>";
                            var adminInfoAuthRoleInfoOnlineUpdate = "<?php echo \think\Session::get('admin_info.auth_role_info.online_update'); ?>";
    ...
    function checkInlet() {
        layer.open({
            ...
            closeBtn: 0,
            shadeClose: true,
            content: '//<?php echo \think\Request::instance()->host(); ?>/doudou/api/Rewrite/setInlet.html',
            success: function(layero, index){
                ...
                if (content.indexOf("Congratulations on passing") == -1)
                {
                    $.ajax({
                        type : "POST",
                        url  : "/doudou/index.php?m=api&c=Rewrite&a=setInlet&_ajax=1",
                        data : {seo_inlet:0},
                        dataType : "JSON",
                        success: function(res) {
