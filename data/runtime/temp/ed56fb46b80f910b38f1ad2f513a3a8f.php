<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1631689732;s:49:"D:\phpstudy_pro\WWW\doudou\template\pc\header.htm";i:1631599279;s:49:"D:\phpstudy_pro\WWW\doudou\template\pc\footer.htm";i:1631534659;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class="page">
			<div class="banner">
				<div class="banner_pic">
					<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_21"); echo $__VALUE__; ?>">
				</div>
				<div class="banner_content">
					<div class="banner_box">
						<img class="banner_slide" src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_22"); echo $__VALUE__; ?>">
						<h2 class="banner_title">Doudou's Blog</h2>
						<div class="banner_cc">
							<div class="banner_cc_box">
								<p><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_23"); echo $__VALUE__; ?></p>
								<div class="banner_cc_list">
									<li>
										<a href="" class="blue" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/qq.png"></a>
									</li>
									<li>
										<a href="" class="blue" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/github.png"></a>
									</li>
									<li>
										<a href="" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/jianshu.png"></a>
									</li>
									<li>
										<a href="" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/zhihu.png"></a>
									</li>
									<li>
										<a href="" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/bilibili.png"></a>
									</li>
									<li>
										<a href=""  class="blue" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/email.png"></a>
									</li>
									<li>
										<a href="" target="_blank"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/template/pc/skin/images/rss.png"></a>
									</li>
								</div>
							</div>
						</div>
						<a class="banner_arrow"></a>
					</div>
				</div>
			</div>
			<div class="main">
				<div class="main_list">
					...
					<div class="notice">
						...
						<div class="notice_content"><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_24"); echo $__VALUE__; ?></div>
					</div>

					<!-- 热门文章 -->
					<div class="hot_list">
						<h1 class="hot_title">热门文章</h1>
						<div class="hot_article">
							<?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "69"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 3; endif; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "c",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> "",      "keyword"=> "", ); $tag = array (
  'typeid' => '69',
  'row' => '3',
  'flag' => 'c',
					...
					<!-- 最新文章 -->
					<div class="ns">
						<h1 class="ns_title">最新文章</h1>
						<div class="ns_article">
							<?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "69"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 10; endif; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> "",      "keyword"=> "", ); $tag = array (
  'typeid' => '69',
  'row' => '10',
  'addfields' => 'article_content',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "", "article_content","desc","",$tag,"0","on","off");if(is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],0, $row, true) : $_result["list"]->slice(0, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 100, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
